...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-yellow-50 rounded-xl shadow-md p-6 border-l-4 border-yellow-500">
        <div class="flex items-center justify-between mb-2">
            <h3 class="text-gray-600 text-sm font-medium">Pemasukan</h3>
            <span class="text-2xl">📈</span>
        </div>
        <p class="text-3xl font-bold text-yellow-600">Rp {{ number_format($totalKeuanganMasuk ?? 0, 0, ',', '.') }}</p>
    </div>

    <!-- Pengeluaran -->
    <div class="bg-red-50 rounded-xl shadow-md p-6 border-l-4 border-red-500">
        <div class="flex items-center justify-between mb-2">
            <h3 class="text-gray-600 text-sm font-medium">Pengeluaran</h3>
            <span class="text-2xl">📉</span>
        </div>
        <p class="text-3xl font-bold text-red-600">Rp {{ number_format($totalKeuanganKeluar ?? 0, 0, ',', '.') }}</p>
    </div>
</div>
