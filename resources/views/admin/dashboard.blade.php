                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    <div class="flex items-center space-x-3">
                                        <div class="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
                                            <span class="text-xl">{{ $pesanan->menu->image ? '🖼️' : '🍚' }}</span>
                                        </div>
                                        <div>
                                            <p class="font-semibold text-gray-800">{{ $pesanan->menu->nama_menu ?? 'Menu' }}</p>
                                            <p class="text-sm text-gray-500">{{ $pesanan->user->name ?? 'User' }}</p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <p class="font-semibold text-gray-800">{{ $menu->nama_menu ?? 'Menu' }}</p>
